import { IChingWilhelmTranslation } from "../types/wilhelm";

/*
 * Dataset retrieved from https://github.com/adamblvck/iching-wilhelm-dataset under MIT license
 */

const ichingWilhelmTranslation: IChingWilhelmTranslation = {
  1: {
    hex: 1,
    hex_font: "\u4dc0",
    trad_chinese: "\u4e7e",
...
export default ichingWilhelmTranslation;
